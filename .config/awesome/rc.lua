...
beautiful.init("/home/tomasos/.config/awesome/theme.lua")
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "web", "chat", "torrent", "other" }, s, layouts[2])
end
-- Set tag 1 to 70% master window width
awful.tag.setmwfact (0.70, tags[1][1])
